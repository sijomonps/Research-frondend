      ...
      <section className="rounded-2xl border border-[color:var(--border)] bg-white p-6 shadow-[0_14px_28px_rgba(91,11,22,0.08)]">
        ...
        <div className="mt-4">
          ...
          {!loading && !submissionId ? (
            <p className="text-sm text-slate-500">Missing submission id.</p>
          ) : null}
              ...
              <div className="rounded-2xl border border-[color:var(--border)] bg-white p-4 shadow-sm">
                ...
                {submission.file?.url ? (
                  <a
                    ...
                    className="mt-3 inline-flex items-center gap-2 text-sm font-semibold text-[color:var(--maroon-700)]"
                    target="_blank"
                    rel="noreferrer"
                  >
